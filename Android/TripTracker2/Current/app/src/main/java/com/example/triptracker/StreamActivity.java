...
//        EdgeToEdge.enable(this);
    ...
    //this function will create the context menu above the page
    @Override
    ...
    //this function will inflate the menu in the three little dots
    @Override
    ...
    //this function will handle events when the menu items are clicked
    @Override
    ...
    //this function is for the presets of the menu
    @Override
